...
echo NV17 - Shark
$MIGRATION_TEST "https://forest-snapshots.fra1.cdn.digitaloceanspaces.com/debug/filecoin_calibnet_height_16900.car.zst"

echo NV18 - Hygge
$MIGRATION_TEST "https://forest-snapshots.fra1.cdn.digitaloceanspaces.com/debug/filecoin_calibnet_height_322454.car.zst"

echo NV19 - Lightning
$MIGRATION_TEST "https://forest-snapshots.fra1.cdn.digitaloceanspaces.com/debug/filecoin_calibnet_height_489194.car.zst"

echo NV20 - Thunder # (no migration should happen in practice, it's a shadow upgrade). We test it anyway.
$MIGRATION_TEST "https://forest-snapshots.fra1.cdn.digitaloceanspaces.com/debug/filecoin_calibnet_height_492314.car.zst"
