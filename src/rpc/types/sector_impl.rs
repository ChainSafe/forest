...
impl From<fil_actor_miner_state::v17::SectorPreCommitOnChainInfo> for SectorPreCommitOnChainInfo {
    fn from(i: fil_actor_miner_state::v17::SectorPreCommitOnChainInfo) -> Self {
        Self {
            info: i.info.into(),
            pre_commit_deposit: i.pre_commit_deposit.into(),
            pre_commit_epoch: i.pre_commit_epoch,
...
impl From<fil_actor_miner_state::v18::SectorPreCommitOnChainInfo> for SectorPreCommitOnChainInfo {
    fn from(i: fil_actor_miner_state::v18::SectorPreCommitOnChainInfo) -> Self {
        Self {
            info: i.info.into(),
            pre_commit_deposit: i.pre_commit_deposit.into(),
            pre_commit_epoch: i.pre_commit_epoch,
...
impl From<fil_actor_miner_state::v17::SectorPreCommitInfo> for SectorPreCommitInfo {
    fn from(i: fil_actor_miner_state::v17::SectorPreCommitInfo) -> Self {
        Self {
            seal_proof: i.seal_proof.into(),
            sector_number: i.sector_number,
            sealed_cid: i.sealed_cid,
...
impl From<fil_actor_miner_state::v18::SectorPreCommitInfo> for SectorPreCommitInfo {
    fn from(i: fil_actor_miner_state::v18::SectorPreCommitInfo) -> Self {
        Self {
            seal_proof: i.seal_proof.into(),
            sector_number: i.sector_number,
            sealed_cid: i.sealed_cid,
