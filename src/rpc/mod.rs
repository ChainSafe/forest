    ...
    DB: Blockstore + Send + Sync + 'static,
{
    ...
    let server = RpseeServer::builder()
        ...
        .set_http_middleware(
            tower::ServiceBuilder::new(), // // Add high level tracing/logging to all requests
                                          // .layer(
                                          //     tower_http::trace::TraceLayer::new_for_http()
                                          //         .on_request(
                                          //             |request: &hyper014::Request<hyper014::Body>, _span: &tracing::Span| tracing::info!(request = ?request, "on_request"),
                                          //         )
...

    {
        ...
        module
            .register_async_method(CHAIN_GET_TIPSET_BY_HEIGHT, chain_get_tipset_by_height::<DB>)?;
        module
            .register_async_method(CHAIN_GET_GENESIS, |_, state| chain_get_genesis::<DB>(state))?;
        ...
        module
            .register_async_method(STATE_MINER_ACTIVE_SECTORS, state_miner_active_sectors::<DB>)?;
        ...
        module
            .register_async_method(MSIG_GET_AVAILABLE_BALANCE, msig_get_available_balance::<DB>)?;
