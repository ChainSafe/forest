...
pub(crate) fn register_actor_methods(registry: &mut MethodRegistry, cid: Cid, version: u64) {
    match version {
        8 => {
            register_reward_version_8_to_9!(registry, cid, fil_actor_reward_state::v8, fvm_shared2)
        }
        9 => {
            register_reward_version_8_to_9!(registry, cid, fil_actor_reward_state::v9, fvm_shared2)
        }
        10 => {
            register_reward_version_8_to_9!(registry, cid, fil_actor_reward_state::v10, fvm_shared3)
        }
