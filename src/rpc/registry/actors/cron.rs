...
pub(crate) fn register_actor_methods(
    ...
    match version {
        ...
        ActorVersion::V18 => register_cron_version!(registry, cid, fil_actor_cron_state::v18),
        ActorVersion::V19 => register_cron_version!(registry, cid, fil_actor_cron_state::v19),
    }
}
