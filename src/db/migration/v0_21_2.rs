...
//! Migration logic for 0.19.0 to 0.21.2 version.
...
pub(super) struct Migration0_19_0_0_21_2 {
    from: Version,
    to: Version,
}

/// Migrates the database from version 0.19.0 to 0.21.2
impl MigrationOperation for Migration0_19_0_0_21_2 {
    ...
    fn migrate(&self, chain_data_path: &Path, _: &Config) -> anyhow::Result<PathBuf> {
        ...
        let new_db = paritydb_0_21_2::ParityDb::open(&temp_db_path)?;
...
/// Database settings from Forest `v0.21.2`
mod paritydb_0_21_2 {
    use parity_db::{CompressionType, Db, Options};
    use std::path::PathBuf;
    use strum::{Display, EnumIter, IntoEnumIterator};
