...
///   [`header`](crate::blocks::header::RawBlockHeader).
///   These are what are mined by miners to get `FIL` (money).
///   They define an [_epoch_](crate::blocks::header::RawBlockHeader::epoch) and a
///   [_parent tipset_](crate::blocks::header::RawBlockHeader::parents).
...
/// and a [_parent state tree_](crate::blocks::header::RawBlockHeader::state_root).
///
/// ```text
