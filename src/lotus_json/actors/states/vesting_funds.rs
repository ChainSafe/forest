...
macro_rules! impl_vesting_funds_lotus_json {
    ($($version_num:literal),+) => {
        $(
        paste! {
            mod [<impl_vesting_fund_ $version_num>] {
                use super::*;
                type T = fil_actor_miner_state::[<v $version_num>]::VestingFund;
                #[test]
                fn snapshots() {
            ...
            mod [<impl_vesting_funds_ $version_num>] {
                use super::*;
                type T = fil_actor_miner_state::[<v $version_num>]::VestingFunds;
                #[test]
                fn snapshots() {
                    crate::lotus_json::assert_all_snapshots::<T>();
                }
