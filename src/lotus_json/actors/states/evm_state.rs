...
impl HasLotusJson for State {
    ...
    fn into_lotus_json(self) -> Self::LotusJson {
        ...
        convert_evm_state!(V10, V11, V12, V13, V14, V15, V16, V17, V18, V19)
    }

    // Always return the latest version when deserializing
    fn from_lotus_json(lotus_json: Self::LotusJson) -> Self {
        let latest_state = fil_actor_evm_state::v19::State::from_lotus_json(lotus_json);
...
impl_evm_state_lotus_json!(with_transient_data: 16, 17, 18, 19);
