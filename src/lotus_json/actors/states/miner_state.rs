...
impl HasLotusJson for State {
    ...
    fn snapshots() -> Vec<(serde_json::Value, Self)> {
        vec![(
            ...
            State::default_latest_version(
                ...
                Default::default(),
                Default::default(),
                fil_actor_miner_state::v19::VestingFunds(None),
                Default::default(),
                Default::default(),
                Default::default(),
                Default::default(),
    ...
    fn into_lotus_json(self) -> Self::LotusJson {
        ...
        convert_miner_state! {
            ...
            embedded_vesting_funds_handler for [V16, V17, V18, V19];
        }
    }
    ...
    fn from_lotus_json(lotus_json: Self::LotusJson) -> Self {
        let vesting_funds = match &lotus_json.vesting_funds {
            Some(VestingFundsValue::Embedded(vesting_funds_json)) => {
                use fil_actor_miner_state::v19::{VestingFund, VestingFunds, VestingFundsInner};
            ...
            Some(VestingFundsValue::Cid(_)) => {
                use fil_actor_miner_state::v19::VestingFunds;
                VestingFunds(None)
            }
            None => {
                use fil_actor_miner_state::v19::VestingFunds;
