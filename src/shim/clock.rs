...
pub use fvm_shared4::ALLOWABLE_CLOCK_DRIFT;
pub use fvm_shared4::BLOCKS_PER_EPOCH;
...
mod tests {
    ...
    #[test]
    fn fvm4_shim_of_const_epoch_duration_seconds() {
        assert_eq!(
            super::EPOCH_DURATION_SECONDS,
            fvm_shared4::clock::EPOCH_DURATION_SECONDS
        )
    }
}
