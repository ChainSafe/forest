...
pub(in crate::message_pool) fn get_base_fee_lower_bound(base_fee: &TokenAmount, factor: i64) -> TokenAmount {
...
pub(in crate::message_pool) fn get_gas_reward(msg: &SignedMessage, base_fee: &TokenAmount) -> TokenAmount {
