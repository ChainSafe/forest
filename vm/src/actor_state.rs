...
mod tests {
    ...
    #[quickcheck]
    fn actorstate_roundtrip(actorstate: crate::json::ActorStateJson) {
        let serialized: String = forest_test_utils::to_string_with!(&actorstate.0, json::serialize);
