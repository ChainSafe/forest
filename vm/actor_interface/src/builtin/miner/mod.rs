...
impl State {
        ...
        BS: BlockStore,
    {
        load_state!(
            store,
            actor,
            (actorv6::MINER_ACTOR_CODE_ID, State::V6),
            (actorv5::MINER_ACTOR_CODE_ID, State::V5),
            (actorv4::MINER_ACTOR_CODE_ID, State::V4),
            (actorv3::MINER_ACTOR_CODE_ID, State::V3),
            (actorv2::MINER_ACTOR_CODE_ID, State::V2),
            (actorv0::MINER_ACTOR_CODE_ID, State::V0)
        )
    }
