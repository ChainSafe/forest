...
pub const SYSTEM_ACTOR_CODE_ID_NAME: &str = "fil/5/system";
pub const INIT_ACTOR_CODE_ID_NAME: &str = "fil/5/init";
pub const CRON_ACTOR_CODE_ID_NAME: &str = "fil/5/cron";
pub const ACCOUNT_ACTOR_CODE_ID_NAME: &str = "fil/5/account";
pub const POWER_ACTOR_CODE_ID_NAME: &str = "fil/5/storagepower";
pub const MINER_ACTOR_CODE_ID_NAME: &str = "fil/5/storageminer";
pub const MARKET_ACTOR_CODE_ID_NAME: &str = "fil/5/storagemarket";
pub const PAYCH_ACTOR_CODE_ID_NAME: &str = "fil/5/paymentchannel";
pub const MULTISIG_ACTOR_CODE_ID_NAME: &str = "fil/5/multisig";
pub const REWARD_ACTOR_CODE_ID_NAME: &str = "fil/5/reward";
pub const VERIFREG_ACTOR_CODE_ID_NAME: &str = "fil/5/verifiedregistry";
pub const CHAOS_ACTOR_CODE_ID_NAME: &str = "fil/5/chaos";
