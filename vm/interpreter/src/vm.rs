...
impl RewardCalc for RewardActorMessageCalc {
    fn reward_message(
        ...
        let rew_msg = Message::new(
            ...
            epoch as u64,
            Default::default(),
            reward::Method::AwardBlockReward as u64,
            params,
            1 << 30,
            Default::default(),
            Default::default(),
