...
pub enum Code {
    ...
    #[mh(code = 0xb220, hasher = multihash::Blake2bHasher::<64>, digest = multihash::Blake2bDigest<64>)]
    Blake2b256,

    /// Identity multihash (max 32 bytes)
    #[mh(code = 0x00, hasher = multihash::IdentityHasher::<64>, digest = multihash::IdentityDigest<64>)]
    Identity,
}
