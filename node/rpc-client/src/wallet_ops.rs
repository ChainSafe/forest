...
pub async fn new(
    ...
    Ok(Filecoin::wallet_new(client, sig_type).await?)
}
...
pub async fn balance(client: &mut RawClient<HTC>, address: String) -> Result<String, JsonRpcError> {
    Ok(Filecoin::wallet_balance(client, address).await?)
}
...
pub async fn set_default(client: &mut RawClient<HTC>, address: String) -> Result<(), JsonRpcError> {
    Ok(Filecoin::wallet_set_default(client, address).await?)
}
...
pub async fn default(client: &mut RawClient<HTC>) -> Result<String, JsonRpcError> {
    Ok(Filecoin::wallet_default(client).await?)
}
...
pub async fn sign(
    ...
    Ok(Filecoin::wallet_sign(client, params).await?)
}
...
pub async fn verify(
    ...
    Ok(Filecoin::wallet_verify(client, params).await?)
}
...
pub async fn import(
    ...
    Ok(Filecoin::wallet_import(client, key_info).await?)
}
...
pub async fn export(
    ...
    Ok(Filecoin::wallet_export(client, address).await?)
}
