...
spellcheck:
	...
	find . \( -path "./documentation" -o -path "./node_modules" -o -path "./.git" -o -path "./target" -o -path "./.github" \) -prune -o -name "*.md" -type f -print0 | xargs -0 -r cargo spellcheck --code 1 --cfg .config/spellcheck.toml || (echo "See .config/spellcheck.md for tips"; false)
