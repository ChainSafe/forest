...
lint: license clean
	...
	taplo fmt --check
	taplo lint
	cargo clippy --features slow_tests --all-targets -- -D warnings -W clippy::unused_async -W clippy::if_not_else
	cargo clippy --all-targets --no-default-features --features forest_deleg_cns,paritydb,instrumented_kernel -- -D warnings -W clippy::unused_async -W clippy::if_not_else
