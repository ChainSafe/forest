...
fn iden() {
    ...
    // uninitialized slice as null, so this needs to be able to be deserialized
    // into empty vector but there is no reason to follow this pattern as they
    // handle the empty array the same.
