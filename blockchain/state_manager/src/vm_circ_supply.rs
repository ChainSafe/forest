...
const EPOCHS_IN_YEAR: ChainEpoch = 365 * actor_interface::EPOCHS_IN_DAY;
const PRE_CALICO_VESTING: [(ChainEpoch, usize); 5] = [
    (183 * actor_interface::EPOCHS_IN_DAY, 82_717_041),
...
const CALICO_VESTING: [(ChainEpoch, usize); 6] = [
    (0, 10_632_000),
    (
        183 * actor_interface::EPOCHS_IN_DAY,
        19_015_887 + 32_787_700,
    ),
