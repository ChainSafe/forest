> [!NOTE]
> This policy is mostly a copy of the [policy](https://github.com/ghostty-org/ghostty/blob/01ea3744c59af4d973e96c5cce2fe8d4aa485e59/AI_POLICY.md) from the Ghostty project, with slight modifications to fit this repository.

# AI Usage Policy

The Forest project has strict rules for AI usage:
...
These rules apply only to **outside** contributions to Forest. Maintainers
...
Please remember that Forest is maintained by humans.
