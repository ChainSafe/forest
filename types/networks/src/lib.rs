...
const UPGRADE_INFOS: [UpgradeInfo; 14] = [
    UpgradeInfo { height: Height::Breeze, version: 1 },
    UpgradeInfo { height: Height::Smoke, version: 2 },
    UpgradeInfo { height: Height::Ignition, version: 3 },
    UpgradeInfo { height: Height::ActorsV2, version: 4 },
    UpgradeInfo { height: Height::Tape, version: 5 },
    UpgradeInfo { height: Height::Kumquat, version: 6 },
    UpgradeInfo { height: Height::Calico, version: 7 },
    UpgradeInfo { height: Height::Persian, version: 8 },
    UpgradeInfo { height: Height::Orange, version: 9 },
    UpgradeInfo { height: Height::Trust, version: 10 },
    UpgradeInfo { height: Height::Norwegian, version: 11 },
    UpgradeInfo { height: Height::Turbo, version: 12 },
    UpgradeInfo { height: Height::Hyperdrive, version: 13 },
    UpgradeInfo { height: Height::Chocolate, version: 14 },
];
...
impl ChainConfig {
    ...
    pub fn network_version(&self, epoch: ChainEpoch) -> NetworkVersion {
        ...
        let version = self.version_schedule
            .iter()
