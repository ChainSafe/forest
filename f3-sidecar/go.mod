...
require (
	...
	golang.org/x/crypto v0.43.0 // Pin crypto@v0.43.0 since assembly optimizations of crypto was removed in https://github.com/golang/crypto/commit/cf29fa96f8b66328e59829f064539321159bfa5b
)
