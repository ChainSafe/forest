...
| `FOREST_F3_CONTRACT_ADDRESS`                              | string                           | empty                                          | `0x476AC9256b9921C9C6a0fC237B7fE05fe9874F50`                  | Set the manifest contract Ethereum address for F3                                                                     |
...
| `FOREST_CHAIN_INDEXER_ENABLED`                            | 1 or true                        | empty                                          | 1                                                             | Whether or not to index the chain to support the Ethereum RPC API                                                     |
